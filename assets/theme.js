...
(function () {
    ...
    AjaxRenderer.prototype = Object.assign({}, AjaxRenderer.prototype, {
      ...
      renderSection: function (html, section) {
        ...
        if (this.onReplace) {
          ...
          $('.grid-product__meta').matchHeight({
            byRow: true,
            property: 'min-height',
            target: null,
            remove: false,
          });
          $('.grid-product__image-mask').matchHeight({
            byRow: true,
            property: 'min-height',
            target: null,
            remove: false,
  ...
  theme.announcementBar = (function () {
    ...
    function init() {
      ...
      document
        ...
        .addEventListener('click', announcementBarClose);

      window.on(
        'resize' + config.namespace,
        theme.utils.debounce(500, announcementBarHeight)
      );
    }
    ...
    function buildCollections(results) {
      ...
      results.forEach((collection) => {
        ...
        if (collection.featured_image.url) {
          new_collection.image = theme.Images.getSizedImageUrl(
    ...
    SlideshowSection.prototype = Object.assign({}, SlideshowSection.prototype, {
      init: function () {
        ...
        if (this.container.hasAttribute('data-parallax')) {
          ...
          this.container.querySelectorAll(selectors.parallaxContainer).forEach(
            function (el, i) {
    ...
    backgroundImage.prototype = Object.assign({}, backgroundImage.prototype, {
      init: function () {
        if (this.container.dataset && this.container.dataset.parallax) {
          var parallaxContainer = this.container.querySelector(
      ...
      onUnload: function (evt) {
        ...
        if (
          ...
          typeof theme.parallaxSections[this.namespace].destroy === 'function'
        ) {
  ...
  theme.CollectionSwitcher = (function () {
    ...
    CollectionSwitcher.prototype = Object.assign(
      {},
      CollectionSwitcher.prototype,
      {
        ...
        initSliders: function () {
          ...
          this.container
            .querySelectorAll(selectors.collection)
            .forEach((collection) => {
              collection.classList.remove('hide');
            });

          sliderArgs.groupCells = theme.config.bpSmall
          ...
          this.slideshows.forEach(
            function (slideshow, i) {
              if (
                this.flickity[i] &&
                typeof this.flickity[i].destroy === 'function'
              ) {
        ...
        switch: function (evt) {
          ...
          if (
            ...
            typeof this.flickity[this.activeIndex].resize === 'function'
          ) {
        ...
        sections: [
          {
            ...
            nodeId: ['CollectionAjaxContent', 'FilterDrawer'],
          },
        ],
  ...
  theme.FadingImages = (function () {
    ...
    FadingImages.prototype = Object.assign({}, FadingImages.prototype, {
      ...
      nextImage: function () {
        var activeImage = this.container.querySelector(
        ...
        var nextImage = this.container.querySelector(
          '.fading-images__item[data-slide-index="' +
            this.data.active_image +
            '"]'
        );
      ...
      nextTitle: function () {
        ...
        window.setTimeout(
          function () {
            ...
            ).textContent = newText1;
            var textTwoContainer = this.container.querySelector(
      ...
      startImages: function () {
        ...
        var firstImage = this.container.querySelector(
          '.fading-images__item[data-slide-index="' +
            this.data.active_image +
            '"]'
        );
      ...
      updateUnitPrice: function (evt) {
        ...
        if (variant && variant.unit_price) {
          ...
          this.container
            ...
            .classList.remove(classes.visuallyHide);
        } else {
          this.container
            .querySelector(this.selectors.unitWrapper)
            .classList.add(classes.visuallyHide);
        }
      },
